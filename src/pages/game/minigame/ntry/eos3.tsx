...
const Eos3: NextPage<props & { userMoney?: number; mutate?: () => void }> = ({
  gameSetup,
  lvsetup,
  minigameSetup,
  data,
  ...
  useEffect(() => {
    ...
    const updateTimer = () => {
      ...
      const playTime = new Date(data.Eos3.Playtime);
  ...
  const odds: PowerballOdds = {
    pbPowerOddOdds: parseFloat(data?.Eos3?.game1_odd_home || "1.95"),
    pbPowerEvenOdds: parseFloat(data?.Eos3?.game1_odd_away || "1.95"),
    pbPowerUnderOdds: parseFloat(data?.Eos3?.game1_odd_under || "1.95"),
    pbPowerOverOdds: parseFloat(data?.Eos3?.game1_odd_over || "1.95"),
    pbNormalOddOdds: parseFloat(data?.Eos3?.game2_odd_home || "1.95"),
    pbNormalEvenOdds: parseFloat(data?.Eos3?.game2_odd_away || "1.95"),
    pbNormalUnderOdds: parseFloat(data?.Eos3?.game2_odd_under || "1.95"),
    pbNormalOverOdds: parseFloat(data?.Eos3?.game2_odd_over || "1.95"),
    pbNormalBigOdds: parseFloat(data?.Eos3?.game3_odd_large || "2.95"),
    pbNormalMidOdds: parseFloat(data?.Eos3?.game3_odd_medium || "2.95"),
    pbNormalSmallOdds: parseFloat(data?.Eos3?.game3_odd_small || "2.95"),
  };

  const codeMapping: Record<string, any> | null = !data?.Eos3
    ? null
    : {
        P_ODD: {
          gameType: "powerball_oe",
          pick: "홀",
          pickOdds: data.Eos3.game1_odd_home,
          team_home: "홀",
          team_away: "짝",
          Odds_home: data.Eos3.game1_odd_home,
          Odds_away: data.Eos3.game1_odd_away,
        },
        P_EVEN: {
          gameType: "powerball_oe",
          pick: "짝",
          pickOdds: data.Eos3.game1_odd_away,
          team_home: "홀",
          team_away: "짝",
          Odds_home: data.Eos3.game1_odd_home,
          Odds_away: data.Eos3.game1_odd_away,
        ...
        P_UNDER: {
          ...
          pick: "언더",
          pickOdds: data.Eos3.game1_odd_under,
          team_home: "언더",
          team_away: "오버",
          Odds_home: data.Eos3.game1_odd_under,
          Odds_away: data.Eos3.game1_odd_over,
        },
        P_OVER: {
          gameType: "powerball_unover",
          pick: "오버",
          pickOdds: data.Eos3.game1_odd_over,
          team_home: "언더",
          team_away: "오버",
          Odds_home: data.Eos3.game1_odd_under,
          Odds_away: data.Eos3.game1_odd_over,
        ...
        N_ODD: {
          gameType: "ball_oe",
          pick: "홀",
          pickOdds: data.Eos3.game2_odd_home,
          team_home: "홀",
          team_away: "짝",
          Odds_home: data.Eos3.game2_odd_home,
          Odds_away: data.Eos3.game2_odd_away,
        },
        N_EVEN: {
          gameType: "ball_oe",
          pick: "짝",
          pickOdds: data.Eos3.game2_odd_away,
          team_home: "홀",
          team_away: "짝",
          Odds_home: data.Eos3.game2_odd_home,
          Odds_away: data.Eos3.game2_odd_away,
        ...
        N_UNDER: {
          ...
          pick: "언더",
          pickOdds: data.Eos3.game2_odd_under,
          team_home: "언더",
          team_away: "오버",
          Odds_home: data.Eos3.game2_odd_under,
          Odds_away: data.Eos3.game2_odd_over,
        },
        N_OVER: {
          gameType: "ball_unover",
          pick: "오버",
          pickOdds: data.Eos3.game2_odd_over,
          team_home: "언더",
          team_away: "오버",
          Odds_home: data.Eos3.game2_odd_under,
          Odds_away: data.Eos3.game2_odd_over,
        ...
        N_BIG: {
          gameType: "ball_size",
          pick: "대",
          pickOdds: data.Eos3.game3_odd_large,
          team_home: "소",
          team_tie: "중",
          team_away: "대",
          Odds_home: data.Eos3.game3_odd_small,
          Odds_tie: data.Eos3.game3_odd_medium,
          Odds_away: data.Eos3.game3_odd_large,
        },
        N_MID: {
          gameType: "ball_size",
          pick: "중",
          pickOdds: data.Eos3.game3_odd_medium,
          team_home: "소",
          team_tie: "중",
          team_away: "대",
          Odds_home: data.Eos3.game3_odd_small,
        ...
        N_SMALL: {
          gameType: "ball_size",
          pick: "소",
          pickOdds: data.Eos3.game3_odd_small,
          team_home: "소",
          team_tie: "중",
          team_away: "대",
          Odds_home: data.Eos3.game3_odd_small,
  ...
  const handleSelect = (code: string | null) => {
    if (isDisable || !data?.Eos3 || !codeMapping) return;
    ...
    const cartData: cartState = {
      id: data.Eos3.id,
      gameCode: "미니게임",
      game_Event: "eos파워볼 3분",
      game_Name: `${data.Eos3.round} 회차`,
      game_Type: gameData.gameType,
      pickOdds: gameData.pickOdds,
      pick: gameData.pick,
      game_Time: data.Eos3.Playtime,
  ...
  return (
    <>
      <Head>
        <title>EOS파워볼 3분 - 미니게임</title>
      </Head>
      <main>
        <MinigameLayoutNew
          list={data?.list}
          src="https://ntry.com/scores/eos_powerball/live.php?game_type=3"
          title="EOS파워볼 3분"
          contentWidth={830}
          contentHeight={640}
          roundNo={data?.Eos3?.round}
          timeLeft={timeLeft}
          gameCode="미니게임"
          game_Event="eos파워볼 3분"
          userMoney={userMoney}
