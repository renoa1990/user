...
> = ({ gameSetup, lvsetup, minigameSetup, data, userMoney, mutate }) => {
  ...
  useEffect(() => {
    ...
    const updateTimer = () => {
      ...
      const playTime = new Date(data.powerball.Playtime);
  ...
  const odds: PowerballOdds = {
    pbPowerOddOdds: parseFloat(data?.powerball?.game1_odd_home || "1.95"),
    pbPowerEvenOdds: parseFloat(data?.powerball?.game1_odd_away || "1.95"),
    pbPowerUnderOdds: parseFloat(data?.powerball?.game1_odd_under || "1.95"),
    pbPowerOverOdds: parseFloat(data?.powerball?.game1_odd_over || "1.95"),
    pbNormalOddOdds: parseFloat(data?.powerball?.game2_odd_home || "1.95"),
    pbNormalEvenOdds: parseFloat(data?.powerball?.game2_odd_away || "1.95"),
    pbNormalUnderOdds: parseFloat(data?.powerball?.game2_odd_under || "1.95"),
    pbNormalOverOdds: parseFloat(data?.powerball?.game2_odd_over || "1.95"),
    pbNormalBigOdds: parseFloat(data?.powerball?.game3_odd_large || "2.95"),
    pbNormalMidOdds: parseFloat(data?.powerball?.game3_odd_medium || "2.95"),
    pbNormalSmallOdds: parseFloat(data?.powerball?.game3_odd_small || "2.95"),
  };

  const codeMapping: Record<string, any> | null = !data?.powerball
    ? null
    : {
        P_ODD: {
          gameType: "powerball_oe",
          pick: "홀",
          pickOdds: data.powerball.game1_odd_home,
          team_home: "홀",
          team_away: "짝",
          Odds_home: data.powerball.game1_odd_home,
          Odds_away: data.powerball.game1_odd_away,
        },
        P_EVEN: {
          gameType: "powerball_oe",
          pick: "짝",
          pickOdds: data.powerball.game1_odd_away,
          team_home: "홀",
          team_away: "짝",
          Odds_home: data.powerball.game1_odd_home,
          Odds_away: data.powerball.game1_odd_away,
        ...
        P_UNDER: {
          ...
          pick: "언더",
          pickOdds: data.powerball.game1_odd_under,
          team_home: "언더",
          team_away: "오버",
          Odds_home: data.powerball.game1_odd_under,
          Odds_away: data.powerball.game1_odd_over,
        },
        P_OVER: {
          gameType: "powerball_unover",
          pick: "오버",
          pickOdds: data.powerball.game1_odd_over,
          team_home: "언더",
          team_away: "오버",
          Odds_home: data.powerball.game1_odd_under,
          Odds_away: data.powerball.game1_odd_over,
        ...
        N_ODD: {
          gameType: "ball_oe",
          pick: "홀",
          pickOdds: data.powerball.game2_odd_home,
          team_home: "홀",
          team_away: "짝",
          Odds_home: data.powerball.game2_odd_home,
          Odds_away: data.powerball.game2_odd_away,
        },
        N_EVEN: {
          gameType: "ball_oe",
          pick: "짝",
          pickOdds: data.powerball.game2_odd_away,
          team_home: "홀",
          team_away: "짝",
          Odds_home: data.powerball.game2_odd_home,
          Odds_away: data.powerball.game2_odd_away,
        ...
        N_UNDER: {
          ...
          pick: "언더",
          pickOdds: data.powerball.game2_odd_under,
          team_home: "언더",
          team_away: "오버",
          Odds_home: data.powerball.game2_odd_under,
          Odds_away: data.powerball.game2_odd_over,
        },
        N_OVER: {
          gameType: "ball_unover",
          pick: "오버",
          pickOdds: data.powerball.game2_odd_over,
          team_home: "언더",
          team_away: "오버",
          Odds_home: data.powerball.game2_odd_under,
          Odds_away: data.powerball.game2_odd_over,
        ...
        N_BIG: {
          gameType: "ball_size",
          pick: "대",
          pickOdds: data.powerball.game3_odd_large,
          team_home: "소",
          team_tie: "중",
          team_away: "대",
          Odds_home: data.powerball.game3_odd_small,
          Odds_tie: data.powerball.game3_odd_medium,
          Odds_away: data.powerball.game3_odd_large,
        },
        N_MID: {
          gameType: "ball_size",
          pick: "중",
          pickOdds: data.powerball.game3_odd_medium,
          team_home: "소",
          team_tie: "중",
          team_away: "대",
          Odds_home: data.powerball.game3_odd_small,
        ...
        N_SMALL: {
          gameType: "ball_size",
          pick: "소",
          pickOdds: data.powerball.game3_odd_small,
          team_home: "소",
          team_tie: "중",
          team_away: "대",
          Odds_home: data.powerball.game3_odd_small,
  ...
  const handleSelect = (code: string | null) => {
    if (isDisable || !data?.powerball || !codeMapping) return;
    ...
    const cartData: cartState = {
      id: data.powerball.id,
      gameCode: "미니게임",
      game_Event: "파워볼",
      game_Name: `${data.powerball.round} 회차`,
      game_Type: gameData.gameType,
      pickOdds: gameData.pickOdds,
      pick: gameData.pick,
      game_Time: data.powerball.Playtime,
      ...
      <main>
        ...
        >
          <PowerballPanel
            ...
            disabled={!data?.powerball || isDisable}
          />
        </MinigameLayoutNew>
      </main>
    </>
...
PowerballPage.displayName = "PowerballPage";

const Page: NextPage<serverSideProps> = (props) => {
  const { data, mutate } = useSWR<SWR>(`/api/minigame/timecounter/파워볼`, {
...
export const getServerSideProps = withSsrSession(async function ({
  ...
  const [minigameSetup, game, levelSetup, basicSetup] = await Promise.all([
    ...
    client.powerballSetup.findFirst({}),
