...
const Special: NextPage<props> = (props) => {
  const {
    data,
    sportsSetup,
    bonus,
...
const Page: NextPage<serverSideProps> = (props) => {
  ...
  const { data, mutate } = useSWR<swr>(`/api/sports/special`, {
    refreshInterval: 0,
  });

  useEffect(() => {
    const newSetup = {
      minBet: props.levelSetup.special_minbet,
      maxBet: props.levelSetup.special_maxbet,
      maxResult: props.levelSetup.special_maxresult,
      minBet_1: props.levelSetup.special_1_minbet,
      maxBet_1: props.levelSetup.special_1_maxbet,
      maxResult_1: props.levelSetup.special_1_maxresult,
    };
