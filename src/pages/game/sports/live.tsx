...
const Live: NextPage<props> = (props) => {
  const {
    data,
    sportsSetup,
    bonus,
...
const Page: NextPage<serverSideProps> = (props) => {
  ...
  const { data, mutate } = useSWR<swr>(`/api/sports/live`, {
    refreshInterval: 0,
  });

  useEffect(() => {
    const newSetup = {
      minBet: props.levelSetup.live_minbet,
      maxBet: props.levelSetup.live_maxbet,
      maxResult: props.levelSetup.live_maxresult,
      minBet_1: props.levelSetup.live_1_minbet,
      maxBet_1: props.levelSetup.live_1_maxbet,
      maxResult_1: props.levelSetup.live_1_maxresult,
    };
